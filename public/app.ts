...
class AudioStreamingApp {
    ...
    private analyser: ScriptProcessorNode | null = null;
    ...
    private startRecordingButton: HTMLButtonElement;
    private stopRecordingButton: HTMLButtonElement;
    private statusElement: HTMLSpanElement;
    private vadStatusElement: HTMLSpanElement;
    private vadDetailsElement: HTMLDivElement;

    constructor() {
        this.connectButton = document.getElementById('connectButton') as HTMLButtonElement;
        this.startRecordingButton = document.getElementById('startRecordingButton') as HTMLButtonElement;
        this.stopRecordingButton = document.getElementById('stopRecordingButton') as HTMLButtonElement;
        this.statusElement = document.getElementById('status') as HTMLSpanElement;
        this.vadStatusElement = document.getElementById('vadStatus') as HTMLSpanElement;
            ...
            this.ws.onmessage = (event) => {
                try {
                    ...
                    if (data.is_speech !== undefined) {
                        this.handleVADResult(data as VADResult);
                    }
                } catch (error) {
